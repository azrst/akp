    ...
    render() {
        return (
            <View style={{ flex: 1 }}>
                ...
                <ImageBackground source={require('../image/splash.png')} style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                        <Image source={require('../image/logo.png')} style={{ height: Screens.height * 30 / 100, width: Screens.height * 30 / 100 }} />
                        <Spinner color='white' />
